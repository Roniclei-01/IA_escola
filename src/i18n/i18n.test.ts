...
describe("i18n", () => {
  ...
  it("has document reader labels in every supported language", () => {
    ...
    expect(i18n.getResource("pt", "translation", "library.translationPageProgress")).toBe(
      "Traduzindo pagina {{currentPage}} de {{totalPages}}."
    );
  ...
  it("has saved document labels in every supported language", () => {
    ...
    expect(i18n.getResource("pt", "translation", "library.categoryFilterLabel")).toBe(
