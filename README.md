...
- previa e exportacao imprimivel em PDF do relatorio de estudo com paginacao, layout de impressao e grafico de desempenho;
...
2. Adicionar tendencias visuais por sessao no relatorio PDF.
