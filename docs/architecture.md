...
A UI usa esses dados para exibir historico visual por documento, uma fila de cards vencidos, filtros, busca textual, ordenacao da biblioteca, comparativo de progresso entre documentos, resumo de desempenho por sessao, tendencia temporal de retencao, exportacao local de relatorio Markdown e exportacao de cards para Anki em TSV.
